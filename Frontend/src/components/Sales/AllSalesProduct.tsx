...
const AllSalesProduct = () => {
  ...
  return (
    <div>
      <div className="py-4 flex flex-row gap-4 items-centerflex w-full">
      ...
      {filteredProducts.length > productsPerPage && (
        <div className="flex items-center justify-center mt-8 gap-2 text-gray-500">
          ...
          >
                    <svg class="mt-px" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.75 12.5h11.5m-11.5 0 4.792-4.791M5.75 12.5l4.792 4.792" stroke="#6B7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
          ...
          >
            <span>Next</span>
            <svg class="mt-px" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17.25 11.5H5.75m11.5 0-4.792-4.79m4.792 4.79-4.792 4.792" stroke="#6B7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
